<?php
    ...
    */
    ...
    define('_DB_NAME', 'aplidija');
    define('_DB_USER', 'root');
    define('_DB_PASS', '');

    # DB CONNECT
    $connection = mysql_connect(_DB_HOST, _DB_USER, _DB_PASS) or die ('Unable to connect to MySQL server. Please make sure your MySQL login details are correct.');
