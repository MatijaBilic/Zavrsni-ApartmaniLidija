(function ($) {
	...
	AvailabilityCalendar.prototype = {
		...
		__createToolbar: function () {
			...
			$inputContainer.append('<input type="button" title="Trenutni" value="Trenutni">');
			$inputContainer.append('<input type="button" title="Prethodni" value="&#10094;">');
			$inputContainer.append('<input type="button" title="Slijedeći" value="&#10095;">');
